...
function Recent({recentBg,twistStyle,white}) {
  return (
    <div className={recentBg}>
       <p className={`${white} font-semibold text-[32px] text-center  mb-4 lg:w-125 w-80 sm:w-100  leading-tight `}>
           Brought Something Recently
        </p>
        <Image src="/twist.png" height={79} width={73} alt="twist" className={twistStyle}/>
        <p className={`${white} font-normal text-[16px] text-center  mb-7 leading-[1.3] lg:w-130 w-80 sm:w-100`}>
