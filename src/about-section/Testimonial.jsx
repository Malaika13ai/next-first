...
const Testimonials = () => {
  ...
  return (
    <section className="px-6 md:px-20 bg-white pb-16">
      ...
      <div className="max-w-7xl mx-auto bg-[#E7F4EF] rounded-[30px] md:rounded-[40px] py-12 md:py-16 px-6 md:px-12 relative overflow-hidden -mt-15.5 shadow-xl border border-white/20">
        ...
        {reviews.map((review) => (
          <SwiperSlide key={review.id} className="pt-12 pb-6">
            <div className="relative">
              ...
              <div className="bg-white rounded-3xl p-6 md:p-8 pt-12 md:pt-14 min-h-60 flex flex-col justify-between relative shadow-sm border border-gray-50">
